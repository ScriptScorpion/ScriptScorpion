...
<cstring> - библиотека для работы со строками и буфферами (операции со строками по типу: копировать, складывать, узнавать длину, сравнивать)
<cctype> - библиотека для проверки типов данных
...
<cstdint> - библиотека типов данных с константным размером (uint8_t - это unsigned int но размер точно будет 8 байт, а например у обычного unsigned int размер может быть 4 а может быть 8 бит)
