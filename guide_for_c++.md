...
различие между `private` и `protected` в том что `private` - он может также использоваться в других классах или структурах(если найследовать), а `protected` - может использоваться только для этого класса или структуры.
